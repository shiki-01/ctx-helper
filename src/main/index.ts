 ...
 */
const registerHandler = <T extends APISchema>(
  key: string,
 ...
 */
const registerAPIHandlers = <T extends APIRecord<APISchema<any>>>(
  apiObj: T,
  parentKey = ""
): void => {
 ...
 */
const registerListener = <T extends APISchema>(
  key: string,
 ...
 * @param parentKey 親のキー
 */
const registerAPIListeners = <T extends APIRecord<any>>(
  apiObj: T,
  parentKey = ""
): void => {
